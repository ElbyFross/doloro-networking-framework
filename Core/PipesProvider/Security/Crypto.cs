...
namespace PipesProvider.Security
{
    ...
    public static class Crypto
    {
        ...
        */
        ...
        /// <param name="encryptionKey">Encryption key generated by AesCryptoServiceProvider.</param>
        /// <param name="callback">Delegate that would be called when data encryption would finished. 
        /// Receiving encrypted data as argument.</param>
        /// <param name="cancellationToken">Token that would be used for termination of operation.</param>
        public async static void AESEncryptAsync(
            byte[] data, 
            byte[] encryptionKey, 
        ...
        /// <summary>
        /// Decrypting binary data wncrypted with AES algorithm.
        /// </summary>
        /// <param name="data">Binary data for decryption.</param>
        /// <param name="encryptionKey">Encryption key generated by AesCryptoServiceProvider. The same that was used during encryption.</param>
        /// <param name="callback">Delegate that would be called when data encryption would finished. 
        /// Receiving encrypted data as argument.</param>
        /// <param name="cancellationToken">Token that would be used for termination of operation.</param>
        public async static void AESDecryptAsync(
            byte[] data, 
            byte[] encryptionKey,
            Action<byte[]> callback,
            System.Threading.CancellationToken cancellationToken)
